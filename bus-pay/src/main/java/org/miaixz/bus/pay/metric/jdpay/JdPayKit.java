...
public class JdPayKit {
    ...
    public static Map<String, String> parseResp(String xml) {
        ...
        String code = (String) getByXPath("//jdpay/result/code", docResult, XPathConstants.STRING);
        String desc = (String) getByXPath("//jdpay/result/desc", docResult, XPathConstants.STRING);
        map.put("code", code);
        map.put("desc", desc);
        if ("000000".equals(code)) {
            String encrypt = (String) getByXPath("//jdpay/encrypt", docResult, XPathConstants.STRING);
