...
public class LunarTime {
    ...
    public static LunarTime from(int lunarYear, int lunarMonth, int lunarDay, int hour, int minute, int second) {
    ...
    public String getShengXiao() {
        return Literal.LUNAR_SHENGXIAO[zhiIndex];
    }
    ...
    public String getNaYin() {
        return Literal.LUNAR_NAYIN.get(getGanZhi());
    }
    ...
    public String getTianShen() {
        return Literal.LUNAR_TIAN_SHEN[(zhiIndex + Literal.LUNAR_ZHI_TIAN_SHEN_OFFSET.get(lunar.getDayZhiExact())) % 12];
    }
    ...
    public String getTianShenType() {
        return Literal.LUNAR_TIAN_SHEN_TYPE.get(getTianShen());
    }
    ...
    public String getTianShenLuck() {
        return Literal.LUNAR_TIAN_SHEN_TYPE_LUCK.get(getTianShenType());
    }
    ...
    public String getChong() {
        return Literal.LUNAR_CHONG[zhiIndex];
    }
    ...
    public String getSha() {
        return Literal.LUNAR_SHA.get(getZhi());
    }
    ...
    public String getChongGan() {
        return Literal.LUNAR_CHONG_GAN[ganIndex];
    }
    ...
    public String getChongGanTie() {
        return Literal.LUNAR_CHONG_GAN_TIE[ganIndex];
    }
    ...
    public List<String> getYi() {
        return Lunar.getTimeYi(lunar.getDayInGanZhiExact(), getGanZhi());
    }
    ...
    public List<String> getJi() {
        return Lunar.getTimeJi(lunar.getDayInGanZhiExact(), getGanZhi());
    }
