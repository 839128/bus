...
public class CIN {
     ...
     * 区域/省市代码表
     */
    public static final Map<String, String> AREA_CODE = new HashMap<>();
    /**
     * 中国台湾身份证首字母对应数字
     */
    public static final Map<Character, Integer> AREA_TW_CODE = new HashMap<>();
    /**
     * 每位加权因子
     */
    ...
    public DateTime getBirthDate() {
        ...
        return DateKit.parse(birth, Fields.PURE_DATE_FORMAT);
    }
    ...
    public int getAge(final Date dateToCompare) {
        return DateKit.getAge(getBirthDate(), dateToCompare);
    }
