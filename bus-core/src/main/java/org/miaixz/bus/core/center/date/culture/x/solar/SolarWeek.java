...
public class SolarWeek {
     ...
     * @return 阳历周
     */
    public static SolarWeek from(Date date, int start) {
     ...
     * @return 阳历周
     */
    public static SolarWeek from(int year, int month, int day, int start) {
                ...
                if (month != weekMonth) {
                    ...
                    if (plus) {
                        ...
                        if (Solar.getWeeksOfMonth(week.getYear(), week.getMonth(), start) == index) {
                            ...
                            solar = Solar.fromYmd(week.getYear(), week.getMonth(), Solar.getDaysOfMonth(week.getYear(), week.getMonth()));
                            week = new SolarWeek(solar.getYear(), solar.getMonth(), solar.getDay(), start);
                        }
                    }
                    month = weekMonth;
