...
public class TreeKit {
     ...
     * @return the list
     */
    public static <T, E> List<Tree<E>> build(List<T> list, E rootId, NodeConfig nodeConfig,
     ...
     * @return {@link Tree}
     */
    public static <T, E> Tree<E> buildSingle(List<T> list, E rootId, NodeConfig nodeConfig,
            NodeParser<T, E> nodeParser) {
