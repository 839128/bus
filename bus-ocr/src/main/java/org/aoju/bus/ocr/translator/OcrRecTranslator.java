 ...
 * 文字识别前后处理
 */
public class OcrRecTranslator implements Translator<Image, WordBlock> {
    private List<String> table;
    private final boolean use_space_char;

    public OcrRecTranslator(Map<String, ?> arguments) {
        use_space_char =
    ...
    @Override
    public WordBlock processOutput(TranslatorContext ctx, NDList list) {
